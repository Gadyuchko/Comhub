...
- Monitoring stack (Prometheus + Grafana) -- Epic 4
- KEDA autoscaling -- Epic 5
- Mailpit email delivery -- Story 2.2
- Comhub application deployments (control-plane, mapper, router, delivery) -- later Epic 1 stories
- Source configuration and event processing -- later stories
