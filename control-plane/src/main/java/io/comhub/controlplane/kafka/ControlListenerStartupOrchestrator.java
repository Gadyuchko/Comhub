 ...
 */
@Component
public final class ControlListenerStartupOrchestrator implements ApplicationRunner {

    private static final Logger log = LoggerFactory.getLogger(ControlListenerStartupOrchestrator.class);

    private final ConfigReplayCoordinator coordinator;
    private final ConfigCache cache;
    private final Duration startupTimeout;

    public ControlListenerStartupOrchestrator(ConfigReplayCoordinator coordinator,
                                              ConfigCache cache,
